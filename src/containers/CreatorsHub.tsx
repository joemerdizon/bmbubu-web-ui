              ...
              <div className="card-body">
                <div className="row mb-5">
                  <div className="col-md-12 col-12">
                    <p className="card-title">Template Tasks</p>
                    <div className="my-3">
                      <hr />
                    </div>
              ...
              <div className="col-md-12 col-12 mb-4">
                <div className="card">
                  <div className="card-body">
                    <div className="row">
                      <div className="col-md-12 col-12">
                        <p className="card-title">Template Options</p>
                        <div className="my-3">
                          <hr />
                        </div>
                      </div>
                      <div className="col-12" style={{ display: "inline-block" }}>
                        <button type="button" className="btn btn-outline-light btn-icon-text btn-sm mx-1">
                        ...
                        <div className="float-right">
                          <button type="button" className="btn btn-outline-danger btn-icon-text btn-sm mx-1">
                            <i className="fa fa-window-close" /> Cancel
                          </button>
                          <button type="button" className="btn btn-outline-success btn-icon-text btn-sm mx-1">
